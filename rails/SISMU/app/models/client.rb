class Client < ApplicationRecord
    ...
    validates :id, :nombre_cli, :apellido_cli, :tel_cli, :direccion_cli, presence: { :message => "«Este campo es obligatorio»"  }
    validates :nombre_cli, :apellido_cli, format: { with: /\A[a-zA-ZÀ-ÿ]+\z/, :message => "«Se permiten solo letras» (no se permiten carácteres especiales o espacios)" }
