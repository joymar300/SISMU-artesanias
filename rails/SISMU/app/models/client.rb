class Client < ApplicationRecord
    ...
    validates :nombre_cli, :apellido_cli, :nombre2_cli, :ciudad, :apellido2_cli, :barrio,  format: { with: /\A[a-zA-Z]+\z/, :message => "«Se permiten solo letras» (no se permiten carácteres especiales o espacios)" }
    ...
    validates :id, :tel_cli, :numericality => { :greater_than_or_equal_to => 0, :less_than_or_equal_to => 99999999999, :message => "No se aceptan números negativos"  }
